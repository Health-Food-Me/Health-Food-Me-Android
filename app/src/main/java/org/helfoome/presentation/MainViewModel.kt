...
class MainViewModel @Inject constructor(private val restaurantRepository: RestaurantRepository) : ViewModel() {
    ...
    fun fetchSelectedRestaurantInfo() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            _selectedRestaurant.postValue(restaurantRepository.fetchRestaurantSummary("62d26c9bd11146a81ef18ea6", "62cf2c468ae4a7cda10f4f4f"))
        }
    }
    ...
    fun fetchReviewList() {
        _reviews.value = listOf(
            ReviewInfo(1,
                ...
                listOf("https://postfiles.pstatic.net/MjAyMjA2MTlfMTM2/MDAxNjU1NjQyOTQ5OTIw.JPYcSZuY_WIVFxj0p7XinmRXH8hEoTqfWHr8ezEifagg.L0P1lCMWpKBhUG-pDQ6SeW1cFVNxhxSJLWMaWzKeOlYg.JPEG.schneesun85/SE-a70a7e59-03f9-453a-8cc3-cb286c1b7038.jpg?type=w773",
