...
enum class FoodType(val color: Int, val icon: Int, val iconTint: Int) {
    ...
    FOOD_SANDWICH(R.color.selector_chip_bg_diet, R.drawable.ic_sandwich, R.color.selector_chip_icon_diet),
    FOOD_QUITO(R.color.selector_chip_bg_diet, R.drawable.ic_kimbap, R.color.selector_chip_icon_diet),
    FOOD_LUNCHBOX(R.color.selector_chip_bg_diet, R.drawable.ic_dosirak, R.color.selector_chip_icon_diet),
    ...
    FOOD_STEAK(R.color.selector_chip_bg_normal, R.drawable.ic_steak, R.color.selector_chip_icon_normal),
