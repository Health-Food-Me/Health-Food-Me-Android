...
class RestaurantMenuViewModel @Inject constructor() : ViewModel() {
    ...
    private fun fetchMenuList() {
        ...
        _menu.value = listOf(
            MenuInfo(1, "연어 샐러디", "https://salady.com/superboard/data/product/thumb/3731617857_Xhu5dfOk_695bba70202d8f821fc2862641575ddced9316e9.jpg", 8400, 24, 26, 15, 297, 50, true),
